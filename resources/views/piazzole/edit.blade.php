...
@section('title', 'Modifica Piazzola')

@section('content')
    <div class="max-w-2xl mx-auto bg-white rounded-lg shadow-sm p-6">
        <h1 class="text-3xl font-bold text-gray-800 mb-6">Modifica Piazzola</h1>

        <form action="{{ route('piazzole.update', $piazzola) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                ...
                <input type="text"
                       name="identificativo"
                       id="identificativo"
                       value="{{ old('identificativo', $piazzola->identificativo) }}"
